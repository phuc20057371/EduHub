...
@RestController
@RequestMapping("/api/v1/pending-edu")
@RequiredArgsConstructor
public class PendingEduInsController {
    private final PendingEduInsService pendingEduInsService;

    @PostMapping("/create")
    public ResponseEntity<PendingEducationInstitutionDTO> createPenEduIns(@RequestBody PendingEducationInstitutionReq request) {
