...
public interface OwnedCourseMapper {
    ...
    OwnedTrainingCourse toEntity(OwnedCourseCreateReq req);
    ...
    @Mapping(target = "status", ignore = true)
    @Mapping(target = "updatedAt", ignore = true)
    OwnedTrainingCourseUpdate toEntity(OwnedCourseUpdateReq req);
    ...
    @Mapping(target = "ownedTrainingCourseUpdate", ignore = true)
    @BeanMapping(nullValuePropertyMappingStrategy = NullValuePropertyMappingStrategy.IGNORE)
    void updateEntityFromRequest(OwnedCourseUpdateReq req, @MappingTarget OwnedTrainingCourse course);
    ...
    @Mapping(target = "status", ignore = true)
    @Mapping(target = "updatedAt", ignore = true)
    void updateUpdateFromRequest(OwnedCourseUpdateReq req, @MappingTarget OwnedTrainingCourseUpdate course);
