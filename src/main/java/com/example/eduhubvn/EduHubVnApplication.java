        ...
        return args -> {
            ...
            try {
                ...
                List<String> middleNames = new ArrayList<>(Arrays.asList(
                        "Văn", "Thị", "Hữu", "Đức", "Ngọc", "Xuân", "Quốc", "Gia", "Trung", "Minh",
                        "Thanh", "Tấn", "Phúc", "Bá", "Duy", "Nhật", "Thái", "Thành", "Tiến", "Anh",
                        "Viết", "Khánh", "Chí", "Tuấn", "Thiện", "Mạnh", "Đình", "Quang", "Tú", "Thi",
                        "Thu", "Tường", "Kim", "Phương", "Tâm", "Thảo", "Hà", "Hải", "Hạnh", "Trà",
                        "Trúc", "Cẩm", "Thùy", "Yến", "Diệu", "Mai", "Hương", "Lan", "Linh", "Loan"
                ));

                // 3. 50 Tên riêng phổ biến
                List<String> firstNames = new ArrayList<>(Arrays.asList(
                        "An", "Bình", "Châu", "Dương", "Đạt", "Dũng", "Giang", "Hà", "Hiếu", "Hoa",
                        "Hòa", "Hùng", "Hương", "Huy", "Khánh", "Kiên", "Lan", "Linh", "Loan", "Long",
                        "Mai", "Minh", "Nam", "Nga", "Ngân", "Ngọc", "Nhung", "Oanh", "Phong", "Phúc",
                        "Quân", "Quỳnh", "Sơn", "Tâm", "Thành", "Thảo", "Thanh", "Thắng", "Thúy", "Trang",
                        "Trúc", "Tuấn", "Tú", "Tùng", "Việt", "Vy", "Yến", "Vinh", "Bảo", "Tiến"
                ));
                ...
                for (int i = 1; i <= 100; i++) {
                    String citizenId = String.format("%011d", faker.number().numberBetween(10000000000L, 99999999999L));
                    ...
                    Lecturer lecturer = Lecturer.builder()
                            ...
                            .address(
                                    addresses.get(faker.random().nextInt(addresses.size()))
                            )
                            .bio(
                                    bios.get(faker.random().nextInt(bios.size()))
                            )
                            .specialization(
                                    specializationWithRankList.get(faker.random().nextInt(specializationWithRankList.size()))
                            )
                ...
                for (int i = 101; i <= 110; i++) {
                    ...
                    EducationInstitution inst = EducationInstitution.builder()
                            ...
                            .institutionName(
                                    trainingCenters.get(faker.random().nextInt(trainingCenters.size()))
                            )
                ...
                for (int i = 111; i <= 120; i++) {
                    ...
                    PartnerOrganization partner = PartnerOrganization.builder()
                            ...
                            .user(user)
                            .organizationName(
                                    companies.get(faker.random().nextInt(companies.size()))
                            )
                            .industry(
                                    faker.options().option(
                ...
                List<String> levels = List.of("Cử nhân", "Thạc sĩ", "Tiến sĩ");
                for (Lecturer lecturer : lecturers) {
                    int degreeCount = faker.number().numberBetween(1, 4); // mỗi lecturer có từ 1 đến 3 degree
                    for (int j = 0; j < degreeCount; j++) {
                        ...
                        Degree degree = Degree.builder()
                                ...
                                .name(
                                        degreesSample.get(faker.random().nextInt(degreesSample.size()))
                                )
                                .major(
                                        specializationWithRankList.get(faker.random().nextInt(specializationWithRankList.size()))
                                )
                                ...
                                .level(
                                        faker.options().option(
                                                "Cử nhân", "Thạc sĩ", "Tiến sĩ", "Cao đẳng", "Trung cấp", "Kỹ sư"
                                        )
                                )
                                .url(degreeUrl)
                                .description(faker.lorem().sentence())
                ...
                List<String> certLevels = List.of("Cơ bản", "Nâng cao", "Chuyên gia");

                for (Lecturer lecturer : lecturers) {
                    int certCount = faker.number().numberBetween(1, 4); // mỗi lecturer có từ 1 đến 3 chứng chỉ
                    for (int j = 0; j < certCount; j++) {
                        ...
                        Certification cert = Certification.builder()
                                ...
                                .name(
                                        certificationsSample.get(faker.random().nextInt(certificationsSample.size()))
                                )
                                .issuedBy(
                                        trainingCenters.get(faker.random().nextInt(trainingCenters.size()))
                                )
                                .issueDate(issueDate)
                                .expiryDate(faker.bool().bool() ? expiryDate : null) // có thể null nếu không có hạn
                                .certificateUrl(
                                        urlCert.get(faker.random().nextInt(urlCert.size()))
                                )
                                .level(
                                        faker.options().option(
                ...
                for (Lecturer lecturer : lecturers) {
                    int numberOfCourses = faker.number().numberBetween(1, 4); // mỗi giảng viên tham gia từ 1 đến 3 khóa
                    for (int j = 0; j < numberOfCourses; j++) {
                        ...
                        AttendedTrainingCourse course = AttendedTrainingCourse.builder()
                                .title(
                                        courseTitles.get(faker.random().nextInt(courseTitles.size()))
                                )
                                .topic(
                                        courseTopics.get(faker.random().nextInt(courseTopics.size()))
                                )
                                .organizer(
                                        companies.get(faker.random().nextInt(companies.size()))
                                )
                ...
                for (Lecturer lecturer : lecturers) {
                    int numberOfCourses = faker.number().numberBetween(1, 4); // mỗi giảng viên sở hữu từ 1 đến 3 khóa
                    for (int j = 0; j < numberOfCourses; j++) {
                        ...
                        OwnedTrainingCourse course = OwnedTrainingCourse.builder()
                                ...
                                .isOnline(isOnline)
                                .address(
                                        isOnline ? "https://app.zoom.us/wc" : addresses.get(faker.random().nextInt(addresses.size())
                                        ))
                ...
                for (Lecturer lecturer : lecturers) {
                    int numberOfProjects = faker.number().numberBetween(1, 4); // Mỗi giảng viên có từ 1 đến 3 đề tài nghiên cứu
                    for (int j = 0; j < numberOfProjects; j++) {
                        ...
                        ResearchProject project = ResearchProject.builder()
                                .title(
                                        researchTopics.get(faker.random().nextInt(researchTopics.size()))
                                )
                                .researchArea(
                                        faker.options().option(
                ...
                for (int i = 1; i <= 100; i++) {
                    ...
                    CourseType courseType = CourseType.values()[faker.random().nextInt(CourseType.values().length)];
                    ...
                    Boolean isOnline = faker.bool().bool();
                    String address = isOnline ? "Zoom" : addresses.get(faker.random().nextInt(researchTopics.size()));

                    LocalDate startDate = LocalDate.now().plusDays(faker.number().numberBetween(0, 30));
                ...
                for (Course course : courses) {
                    ...
                    while (selectedLecturers.size() < numberOfLecturers) {
                        Lecturer randomLecturer = lecturers.get(faker.number().numberBetween(0, lecturers.size()));
                    ...
                    for (Lecturer lecturer : lecturerList) {
                        ...
                        if (lecturer.equals(author)) {
                            ...
                            role = faker.options().option(CourseRole.ASSIGNED, CourseRole.ASSISTANT);
                        }
